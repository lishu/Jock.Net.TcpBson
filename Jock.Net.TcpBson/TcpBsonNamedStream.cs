...
namespace Jock.Net.TcpBson
{
    ...
    /// </summary>
    public class TcpBsonNamedStream : Stream
    {
        private const long FREE_READED_CACHE_SIZE = 1024 * 1024;
        private TcpBsonClient TcpBsonClient;
        private MemoryStream readCache = new MemoryStream();
        private MemoryStream writeCache = new MemoryStream();

        internal TcpBsonNamedStream(TcpBsonClient TcpBsonClient)
        {
            this.TcpBsonClient = TcpBsonClient;
        }
        ...
        {
            TcpBsonClient.FlushNamedStream(this);
        }

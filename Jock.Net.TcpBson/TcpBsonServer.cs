...
namespace Jock.Net.TcpBson
{
    ...
    /// </summary>
    public class TcpBsonServer : SafeThreadObject
    {
        private IPEndPoint mListenerPoint;
        private TcpListener mListener;
        private WeakList<TcpBsonServerClient> mClients = new WeakList<TcpBsonServerClient>();

        /// <summary>
        ///Create a Json Communication server
        /// </summary>
        /// <param name="listenerPoint">Listening port</param>
        public TcpBsonServer(IPEndPoint listenerPoint)
        {
        ...
        /// </summary>
        public IEnumerable<TcpBsonServerClient> Clients => mClients;
        ...
        {
            var serverClient = new TcpBsonServerClient(this, tcpClient);
        ...
        {
            mClients.Remove((TcpBsonServerClient)sender);
        }
    }
    ...
    public class ConnectedEventArgs : EventArgs
    {
        ...
        /// </summary>
        public TcpBsonServerClient ServerClient { get; }

        internal ConnectedEventArgs(TcpBsonServerClient serverClient)
        {
